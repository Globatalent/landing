    ...
    return (
      <section id="about" className="section is-centered columns" style={{paddingTop: "1.5rem"}}>
        <article className="column is-3">
          ...
          <h2 className="title is-4 has-text-centered" style={{marginBottom: "1rem"}}>Exclusive platform</h2>
        ...
        <article className="column is-3">
          ...
          <h2 className="title is-4 has-text-centered" style={{marginBottom: "1rem"}}>Share the profits</h2>
        ...
        <article className="column is-3">
          ...
          <h2 className="title is-4 has-text-centered" style={{marginBottom: "1rem"}}>Tokenization</h2>
