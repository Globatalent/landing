                  ...
                  <div className="control">
                    <div className="select is-fullwidth">
                      <select name='LEADCF3'>
                        ...
                        <option value='Automobile&#x20;Racing'>{this.props.t('form.field_6.option_6')}</option>
                        <option value='Martial&#x20;Arts'>{this.props.t('form.field_6.option_7')}</option>
                        <option value={this.props.t('form.field_6.option_8')}>{this.props.t('form.field_6.option_8')}</option>
                        <option value="Motorcycle&#x20;Racing">{this.props.t('form.field_6.option_9')}</option>
